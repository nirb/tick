    ...
    >
      ...
      >
        ...
        <div className="text-center mb-4">
          <div className="w-12 h-12 rounded-2xl bg-rose-500/20 border border-rose-400/40 text-rose-400 flex items-center justify-center shadow-lg shadow-rose-500/20 mx-auto mb-3">
        ...
        {taskTitle && (
          <div className="my-4 p-3.5 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-3">
            <div className="w-2.5 h-2.5 rounded-full shrink-0 bg-rose-400 shadow-sm shadow-rose-400/50" />
        ...
        <div className="flex items-center gap-3 mt-6">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className="flex-1 px-4 py-2.5 rounded-xl bg-gradient-to-r from-rose-500 to-red-600 hover:from-rose-400 hover:to-red-500 text-white text-xs sm:text-sm font-bold shadow-lg shadow-rose-500/25 transition-all flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-400 disabled:opacity-50 cursor-pointer"
          >
            {loading ? (
